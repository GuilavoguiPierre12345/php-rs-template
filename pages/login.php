<?php 
    ...
    if(isset($connexion)){
        ...
        if(empty($telephone) || empty($password)){
			...
			$pdo=bdd();
			$verif=$pdo->PREPARE("SELECT*FROM users WHERE telephone=? AND password=?");
			$verif->execute([$telephone,sha1($password)]);
			if($verif->rowCount()>0){
				$_SESSION['telephone']=$telephone;
				header('Location:accueil.php');
			}else{
				$errors="Numero de telephone ou mot de passe incorrect";
			}
        }
    }
									...
									<div class="row row-sm">
										<div class="card-body mt-2 mb-2">
											...
											<form action="" method="post"> 
												<h5 class="text-start mb-2">Authentification</h5>
                                                <?php if(isset($errors)) :?>
												...
												<div class="form-group text-start">
													...
													<input name="telephone" value="<?php if(isset($telephone)) echo $telephone; ?>" class="form-control" placeholder="Numero de telephone" type="text">
												</div>
												<div class="form-group text-start">
													<label>Mot de passe</label>
													<input name="password" class="form-control" placeholder="Entrer le mot de passe" type="password">
												</div>
                                                <button name="connexion" class="btn btn-main-primary btn-block text-white">Connexion</button>
												
											</form>
											<div class="text-start mt-5 ms-0">
												<div class="mb-1"><a href="forgot.html">Mot de passe oublie ?</a></div>
												<div>Vous n'avez pas un compte ? <a href="inscription.php">S'inscrire ici</a></div>
											</div>
										</div>
									</div>
								</div>
